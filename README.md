...
O Martelos aceita expressões complexas. Exemplos: sqrt(pi) * 2, sin(pi/2) + log(3), pi^2 / 6.
...
| :---: | :--- | :--- | :--- |
| **AES-256** | Bloco / Militar | **Chaves dinâmicas sem IVs fixos** | AES possui aceleração em hardware |
| **RSA** | Chaves Públicas | **Imune a fatoração simples** | Exige canal seguro de troca manual |
| **ChaCha20** | Fluxo em Software | **Complexidade N-Camadas auto-mutáveis** | ChaCha20 possui maior adoção |
| **PGP / GPG** | E-mails / Assinatura | **Transmutação e Glitch Art nativos** | PGP possui ecossistema integrado |
| **OTP** | Segurança Absoluta | **Chaves curtas geram entropia irracional** | OTP exige chave do tamanho do dado |
| **Twofish** | Flexibilidade | **Zero metadados em modo .martelos** | Documentação acadêmica massiva |
