...
void exibir_banner() {
    ...
    printf("              \"Livre e Open Source\" (v2.1)\n");
    printf("===================================================================\n");
}
...
void menu_bbp() {
    ...
    printf("5 - Constante Arctan (Plouffe/Gregory)\n");
    printf("0 - Voltar\nEscolha: ");
}
...
int main() {
    ...
    while (1) {
        ...
        if (principal == 1) {
            ...
            int tipo = 0;
            if (sub == 1) tipo = 1;      
            else if (sub == 2) tipo = 3; 
            else if (sub == 3) tipo = 4; 
            else if (sub == 4) tipo = 5; 
            else if (sub == 5) tipo = 6; 
